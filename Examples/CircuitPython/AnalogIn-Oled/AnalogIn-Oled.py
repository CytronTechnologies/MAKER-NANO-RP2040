...
###  Hardware: Grove - OLED Display 0.96 inch - SSD1315 ;; Reference: www.cytron.io/p-grove-oled-display-0p96-inch-ssd1315
...
# function to calculate voltage from analog readings
def get_voltage(pin):
